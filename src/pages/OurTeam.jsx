...
const THEMES = {
  ...
  ADV: { border: 'border-brown-200', bg: 'bg-brown-50', text: 'text-brown-800', shadow: 'shadow-brown-100/50', gradient: 'from-brown-600 to-brown-800', line: 'border-brown-300', vline: 'bg-brown-300', iconBg: 'bg-brown-50' },
