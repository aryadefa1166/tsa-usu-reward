...
// ==========================================
// TEMA WARNA DEPARTEMEN MUTLAK (SUBTLE ACCENTS)
// ==========================================
const THEMES = {
  BPH: { border: 'border-pink-200/50', text: 'text-pink-600', shadow: 'shadow-pink-100/30', gradient: 'from-pink-400 to-pink-600', line: 'bg-pink-100', iconBg: 'bg-pink-50' },
  ADV: { border: 'border-amber-200/50', text: 'text-amber-700', shadow: 'shadow-amber-100/30', gradient: 'from-amber-600 to-amber-800', line: 'bg-amber-100', iconBg: 'bg-amber-50' },
  ERBD: { border: 'border-emerald-200/50', text: 'text-emerald-600', shadow: 'shadow-emerald-100/30', gradient: 'from-emerald-400 to-emerald-600', line: 'bg-emerald-100', iconBg: 'bg-emerald-50' },
  MD: { border: 'border-purple-200/50', text: 'text-purple-600', shadow: 'shadow-purple-100/30', gradient: 'from-purple-400 to-purple-600', line: 'bg-purple-100', iconBg: 'bg-purple-50' },
  STD: { border: 'border-blue-200/50', text: 'text-blue-600', shadow: 'shadow-blue-100/30', gradient: 'from-blue-400 to-blue-600', line: 'bg-blue-100', iconBg: 'bg-blue-50' },
};

// ==========================================
// KOMPONEN CARD MEMBER (TEMA MUTLAK TSA USU DENGAN AKSEN DEPT)
// ==========================================
const MemberCard = ({ member, deptCode }) => {
  ...
  return (
    <div className={`bg-white rounded-2xl border ${theme.border} ${theme.shadow} p-5 flex flex-col items-center text-center hover:shadow-md transition-all duration-300 relative overflow-hidden w-full max-w-[200px] mx-auto z-10`}>
      ...
      <div className={`w-20 h-20 rounded-full border-4 ${theme.iconBg} overflow-hidden mb-3 relative shadow-inner flex-shrink-0 bg-white`}>
        {member.photo_url ? (
...
// ==========================================
// KONEKTOR GARIS (UI HELPERS) - DINAMIS
// ==========================================
          ...
          <div className="space-y-16 animate-fade-in-up">
            ...
            <section className="relative bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
              <div className="flex flex-col items-center mb-10">
                <div className={`p-3 ${THEMES.BPH.iconBg} rounded-2xl mb-3 shadow-sm border ${THEMES.BPH.border}`}>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className={`w-[260px] h-px ${THEMES.BPH.line} hidden md:block`}></div>
                <div className="hidden md:flex justify-between w-[260px]">
                  <VLine height="h-8" color={THEMES.BPH.line} />
                  <VLine height="h-8" color={THEMES.BPH.line} />
                </div>
                
                <div className="flex justify-center gap-10 w-full max-w-lg mt-6 md:mt-0">
            ...
            <section className="relative bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
              <div className="flex flex-col items-center mb-10">
                <div className={`p-3 ${THEMES.ADV.iconBg} rounded-2xl mb-3 shadow-sm border ${THEMES.ADV.border}`}>
              ...
              <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
                ...
                <h3 className={`text-sm font-black uppercase tracking-widest mt-12 mb-6 ${THEMES.ADV.text}`}>Monitoring & Evaluation</h3>
            ...
            <section className="relative bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
              <div className="flex flex-col items-center mb-10">
                <div className={`p-3 ${THEMES.ERBD.iconBg} rounded-2xl mb-3 shadow-sm border ${THEMES.ERBD.border}`}>
            ...
            <section className="relative bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
              <div className="flex flex-col items-center mb-10">
                <div className={`p-3 ${THEMES.MD.iconBg} rounded-2xl mb-3 shadow-sm border ${THEMES.MD.border}`}>
            ...
            <section className="relative bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
              <div className="flex flex-col items-center mb-10">
                <div className={`p-3 ${THEMES.STD.iconBg} rounded-2xl mb-3 shadow-sm border ${THEMES.STD.border}`}>
